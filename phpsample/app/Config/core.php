 ...
 *
 */
	Configure::write('Routing.prefixes', array('admin', 'teacher'));
 ...
 */
	Configure::write('Security.salt', 'tekidounaatainihennkousimasuyo');

/**
 * A random numeric string (digits only) used to encrypt/decrypt strings.
 */
	Configure::write('Security.cipherSeed', '829476138957208478374972');
